...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" name="product_name" value="<?php echo $rs['product_name'];?>" placeholder="enter the product name">
      <input type="number" min="0" class="box" name="product_price" value="<?php echo $rs['product_price'];?>" placeholder="enter the product price">
