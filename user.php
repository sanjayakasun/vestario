        ...
        <div class="container">
            ...
            <div class="col-md-6">
                <div class="container">
                    ...
                    <div class="tracking" style="width: 68vh;height: 40vh;">
                        <h2 style="color: gray;">Track your order here</h2>
                        <div>
                            <?php
                            $user=new RegisteredCustomer(null,null,null,null,null,null,null);
                            $rs=$user->getorderdetails($customerId);
                            $status = $rs->deliveryStatus;
                            $orderid = $rs->orderId;
                            ?>
                            <label>Order Id: <?php echo $orderid;?></label> <br>
                            <label>Order Status : </label>
                            <label style="border-radius:10px; width:200px;background-color:white;"> <?php echo $status;?> </label>
                            <br><br>
                            
                        </div>
                        <div>
                            <button class="btn btn-success">Track Location</button>
                        </div>
                        <br>
                        <br>
                        <!--php code hoes from here to update order place mapping-->
                        <div class="col">
                            <div >
