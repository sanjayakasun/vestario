...
<html lang="en">
    ...
    <head>
        ...
        <title>Women's Classic Pant</title>
                    ...
                    <div class="bg-light border rounded border-0 border-dark overflow-hidden">
                        <div class="row">
                            <div class="container mt-3">
                                <div class="row">
                                    <div class="col-12">
                                        <h1 class="text-center">Women's Classic Pant</h1>
                                    </div>
                                </div><!--row header-->

                                <?php
                                @include 'config.php';
                                $select = mysqli_query($conn, "SELECT * FROM product WHERE category = 'women' AND product_name LIKE 'Womens clas%' ");
                                ?>
